...
public class UserGroupPermissionController {
    ...
    public boolean save(@RequestBody UserGroupPermission userGroupPermission) {
        return userGroupPermissionService.save(userGroupPermission);
    }
    ...
    public boolean remove(@PathVariable Serializable id) {
        return userGroupPermissionService.removeById(id);
    }
     ...
     */
    @PutMapping("update")
    public boolean update(@RequestBody UserGroupPermission userGroupPermission) {
        return userGroupPermissionService.updateById(userGroupPermission);
    }
     ...
     */
    @GetMapping("list")
    public List<UserGroupPermission> list() {
        return userGroupPermissionService.list();
    }
    ...
    public UserGroupPermission getInfo(@PathVariable Serializable id) {
        return userGroupPermissionService.getById(id);
    }
    ...
    public Page<UserGroupPermission> page(Page<UserGroupPermission> page) {
        return userGroupPermissionService.page(page);
    }
