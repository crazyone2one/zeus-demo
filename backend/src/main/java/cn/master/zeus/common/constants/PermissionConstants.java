...
public class PermissionConstants {
    ...
    public static final String PROJECT_UI_SCENARIO_READ_MOVE_COPY = "PROJECT_UI_SCENARIO:READ+BATCH_COPY";
    ...
    public static final String PROJECT_UI_ELEMENT_READ_CREATE = "PROJECT_UI_ELEMENT:READ+CREATE";
    public static final String PROJECT_UI_ELEMENT_READ_EDIT = "PROJECT_UI_ELEMENT:READ+EDIT";
    public static final String PROJECT_UI_ELEMENT_READ_DELETE = "PROJECT_UI_ELEMENT:READ+DELETE";
